...
for curve_id=1:7
    ...
    switch curve_id
        ...
        case 1
            plot(eps_plot,stress_plot,'Color',[0.4 0 0.6],'LineWidth',2)

        case 2
            plot(eps_plot,stress_plot,'Color',[0.5 0.3 0.7],'LineWidth',2,'LineStyle','--')

        case 3
            plot(eps_plot,stress_plot,'Color',[0.8 0.4 0.6],'LineWidth',2)

        case 4
            plot(eps_plot,stress_plot,'Color',[0 0.5 0],'LineWidth',2)

        case 5
            plot(eps_plot,stress_plot,'Color',[0 0.5 0],'LineWidth',2,'LineStyle','--')

        case 6
            plot(eps_plot,stress_plot,'Color',[0 0.8 0],'LineWidth',2)

        case 7
            plot(eps_plot,stress_plot,'Color',[0.45 0.75 0.45],'LineWidth',2,'LineStyle','--')
...
legend('DN1 T1','DN1 T2','DN1 T3','DN2 T1','DN2 T2','DN2 T3', 'DN2 T4','Location','northwest')
